...
if __name__ == "__main__":
    ...
    asset = {
        ...
        "technical_characteristics": [
            {"field": "ipv4-addr:value", "data": "192.168.140.100"},
            {"field": "mac-addr:value", "data": "00.00.54.20.27.89"},
            {"field": "network-traffic:protocols[*]", "data": "Modbus"},
            {"field": "Firmware Version", "data": "Version here"},
            {"field": "Manufacturer", "data": "schneider"},
            {"field": "Model", "data": "modicon"},
            {"field": "OS", "data": "VxWorks"},
            {"field": "OS Version", "data": "version number"},
        ],
